...
from TrungtinBlog import db, bcrypt
from TrungtinBlog.models import User, Post
from TrungtinBlog.users.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm
from TrungtinBlog.posts.forms import PostForm
from TrungtinBlog.users.utils import save_picture, send_reset_email
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent with instruction to resset your password.', 'info')
        return redirect(url_for('users.login'))
